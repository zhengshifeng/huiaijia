...
public class JSONUtils {
	 ...
	 * @return void
	 */
	public static void printStr(String jsonStr, HttpServletResponse httpServletResponse) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void printObject(Object obj, HttpServletResponse httpServletResponse, JsonConfig config)
			throws IOException {
		JSONObject jsObject = JSONObject.fromObject(obj, config);
		printStr(jsObject.toString(), httpServletResponse);
	}

	public static void printObject(Object obj, HttpServletResponse httpServletResponse) throws IOException {
	 ...
	 * @return void
	 */
	public static void printArray(List<?> list, HttpServletResponse httpServletResponse) throws IOException {
		JSONArray jsArray = JSONArray.fromObject(list);
		printStr(jsArray.toString(), httpServletResponse);
	}
