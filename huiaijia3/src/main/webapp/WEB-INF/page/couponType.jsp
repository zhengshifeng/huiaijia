...
<div class="mainBox">
	...
	<div class="navList">
		<ul class="tab">
			<li><a href="javascript:;" class="selected">品类</a></li>
			<li><a href="/couponBrand/listWithTreeNodes.html?couponId=${vo.couponId}">品牌</a></li>
		</ul>
	...
	$(document).ready(function () {
		...
		$("#btn_submit").click(function () {
			...
			for (var i = 0; i < checked_nodes.length; i++) {
				if (checked_nodes[i].level == 2) {
					typeIds.push(checked_nodes[i].id);
				}
			}

			if (typeIds.length > 0) {
				var url = '/couponType/save.html';
				var data = 'couponId=${vo.couponId}&typeList='+typeIds;
