...
<head>
	...
	<title>【${community.communityName}】楼栋管理</title>
...
<div class="mainBox">
	<h3>
		<a href="/exactSearchVillage.html?parameter=${community.id }&page=villageView" class="actionBtn">小区详情</a>
		【${community.communityName}】楼栋管理
	</h3>
...
<script type="text/javascript">
	...
	function onRemove(e, treeId, treeNode) {
		var url = "/communityBuilding/delete.html";
	...
	function onRename(e, treeId, treeNode) {
		var url = "/communityBuilding/save.html";
		var postData = 'id=' + treeNode.id
			+ '&name=' + treeNode.name
